	...
	<section>
		...
		<%@ include file="./slide.jsp" %>
			...
			<div class="artist-main">
				<img alt="골든차일드 소개" src="../images/golden_main.jpg">
				<div class="artist-mv">
					<iframe width="734" height="419" src="https://www.youtube.com/embed/2OGmEM-hExU" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
