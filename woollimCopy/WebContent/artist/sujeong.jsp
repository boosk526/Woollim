	...
	<section>
		...
		<%@ include file="./slide.jsp" %>
			...
			<div class="artist-main">
				<img alt="이수정 소개" src="../images/sj_main.jpg">
				<div class="artist-mv">
				<iframe width="734" height="419" src="https://www.youtube.com/embed/bn8hChtePD4" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
