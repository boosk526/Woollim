	...
	<section>
		...
		<%@ include file="./slide.jsp" %>
			...
			<div class="artist-main">
				<img alt="로켓펀치 소개" src="../images/rp_main.jpg">
				<div class="artist-mv">
				<iframe width="734" height="419" src="https://www.youtube.com/embed/N_2xEKsvkLo" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
