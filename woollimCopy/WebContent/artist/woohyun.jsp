	...
	<section>
		...
		<%@ include file="./slide.jsp" %>
			...
			<div class="artist-main">
				<img alt="남우현 소개" src="../images/wh_main.jpg">
				<div class="artist-mv">
				<iframe width="734" height="419" src="https://www.youtube.com/embed/Bn__3gkWBto" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
