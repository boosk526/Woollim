		...
		<%@ include file="./slide.jsp" %>
			<div class="menu-li">
				<div class="menu-li-in">
					<h3>INFINITE</h3>
					<ul>
						<li class="li-bo li-ma"><a href="">MAIN</a></li>
						<li class="li-bo li-about"><a href="../schedule/schedule.jsp">SCHEDULE</a></li>
						<li class="li-about"><a href="">GALLERY</a></li>
					</ul>
				</div>
			</div>
			<div class="artist-main">
				<img alt="인피니트 소개" src="../images/infinite_main.jpg">
				<div class="artist-mv">
					<iframe width="734" height="419" src="https://www.youtube.com/embed/TM-gCW45YHc" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
