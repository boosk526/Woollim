		...
		<%@ include file="./slide.jsp" %>
			<div class="menu-li">
				<div class="menu-li-in">
					<h3>KWON EUN BI</h3>
					<ul>
						<li class="li-bo li-ma"><a href="./eunbi.jsp">MAIN</a></li>
			...
			<div class="artist-main">
				<img alt="권은비 소개" src="../images/eunbi_main.jpg">
				<div class="artist-mv">
				<iframe width="734" height="419" src="https://www.youtube-nocookie.com/embed/enSvdtEutuw" title="YouTube video player" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</div>
