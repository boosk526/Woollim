	...
	<section>
		...
		<%@ include file="../artist/slide.jsp" %>
			...
			<div class="gallery-wrap">
				<div class="gallery">
					<ul class="gallery-pt">
						<li class="js-load"><img alt="" src="../images/dmsql1.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql2.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql5.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql3.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql4.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql1.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql2.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql5.jpg"></li>
						<li class="js-load"><img alt="" src="../images/dmsql3.jpg"></li>
